...
# If you come from bash you might have to change your $Par -C /usr/local -xzf go1.19.3.linux-amd64.tar.gzar -C /usr/local -xzf go1.19.3.linux-amd64.tar.gzar -C /usr/local -xzf go1.19.3.linux-amd64.tar.gzar -C /usr/local -xzf go1.19.3.linux-amd64.tar.gzar -C /usr/local -xzf go1.19.3.linux-amd64.tar.gzATH.
# export Par -C /usr/local -xzf go1.19.3.linux-amd64.tar.gzar -C /usr/local -xzf go1.19.3.linux-amd64.tar.gzar -C /usr/local -xzf go1.19.3.linux-amd64.tar.gzATH=$HOME/bin:/usr/local/bin:$PATH
...
function ngg()
{
	(nb get "v1/tenant/$1?environment=$2") | grep -e \"mysql\": -e \"jobs\" -A 10
}
function ng() {
    nb get "v1/tenant/$1?environment=$2"
}
